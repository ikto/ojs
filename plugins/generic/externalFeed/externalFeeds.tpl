...
<p class="help-block">{translate key="plugins.generic.externalFeed.manager.displayBlockInstructions" setupStep56=$setup56}</p>

<br />

<div id="feeds" class="col-md-12 mag-innert-left">
	...
	<div class="table-responsive">
		<table width="100%" class="table table-striped">
			...
			<tr class="heading" valign="bottom">
				<td width="40%"><label>{translate key="plugins.generic.externalFeed.manager.title"}</label></td>
				<td width="15%"><label>{translate key="plugins.generic.externalFeed.manager.displayHomepage"}</label></td>
				<td width="25%" colspan="2"><label>{translate key="plugins.generic.externalFeed.manager.displayBlock"}</label>
					<table width="100%" class="table table-striped">
						<tr valign="top">
							<td width="50%" style="padding: 0 4px 0 0; font-size: 1.0em"><label>{translate key="plugins.generic.externalFeed.manager.displayBlockAll"}</label></td>
							<td width="50%" style="padding: 0 4px 0 0; font-size: 1.0em"><label>{translate key="plugins.generic.externalFeed.manager.displayBlockHomepage"}</label></td>
						</tr>
					</table>
				</td>
			...
			{if $feeds->wasEmpty()}
				<tr>
					<td colspan="5" class="nodata"><p class="help-block">{translate key="plugins.generic.externalFeed.manager.noneCreated"}</p></td>
				</tr>
				<tr>
