...
<div id="citation" class="col-md-12 mag-innert-left">
	<form role="form" action="http://www.refworks.com/express/expressimport.asp?vendor=Public%20Knowledge%20Project&filter=BibTeX&encoding=65001" method="post" target="RefWorksMain">
		<div class="form-group"><textarea name="ImportData" rows=15 cols=70 class="form-control">{literal}@article{{{/literal}{$journal->getLocalizedInitials()|escape}{literal}}{{/literal}{$articleId|escape}{literal}},
	...
	}{/literal}</textarea></div>
		<br />
		<input type="submit" class="btn btn-success" name="Submit" value="{translate key="plugins.citationFormats.refWorks.export"}" />
	</form>
</div>