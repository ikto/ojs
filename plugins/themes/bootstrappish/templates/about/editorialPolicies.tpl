...
<div id="focusAndScope" class="col-md-12 mag-innert-left"><h3>{translate key="about.focusAndScope"}</h3>
<p class="text">{$currentJournal->getLocalizedSetting('focusScopeDesc')|nl2br}</p>

<div class="separator">&nbsp;</div>
</div>
{/if}

<div id="sectionPolicies" class="col-md-12 mag-innert-left"><h3>{translate key="about.sectionPolicies"}</h3>
{foreach from=$sections item=section}{if !$section->getHideAbout()}
	...
	{if strlen($section->getLocalizedPolicy()) > 0}
		<p class="text">{$section->getLocalizedPolicy()|nl2br}</p>
	{/if}
...
{if $currentJournal->getLocalizedSetting('reviewPolicy') != ''}<div id="peerReviewProcess" class="col-md-12 mag-innert-left"><h3>{translate key="about.peerReviewProcess"}</h3>
<p class="text">{$currentJournal->getLocalizedSetting('reviewPolicy')|nl2br}</p>
...
<div id="publicationFrequency" class="col-md-12 mag-innert-left"><h3>{translate key="about.publicationFrequency"}</h3>
<p class="text">{$currentJournal->getLocalizedSetting('pubFreqPolicy')|nl2br}</p>
...
<div id="openAccessPolicy" class="col-md-12 mag-innert-left"><h3>{translate key="about.openAccessPolicy"}</h3>
<p class="text">{$currentJournal->getLocalizedSetting('openAccessPolicy')|nl2br}</p>
...
<div id="authorSelfArchivePolicy" class="col-md-12 mag-innert-left"><h3>{translate key="about.authorSelfArchive"}</h3> 
<p class="text">{$currentJournal->getLocalizedSetting('authorSelfArchivePolicy')|nl2br}</p>
...
<div id="delayedOpenAccessPolicy" class="col-md-12 mag-innert-left"><h3>{translate key="about.delayedOpenAccess"}</h3> 
<p class="text">{translate key="about.delayedOpenAccessDescription1"} {$currentJournal->getSetting('delayedOpenAccessDuration')} {translate key="about.delayedOpenAccessDescription2"}</p>
{if $currentJournal->getLocalizedSetting('delayedOpenAccessPolicy') != ''}
	<p class="text">{$currentJournal->getLocalizedSetting('delayedOpenAccessPolicy')|nl2br}</p>
{/if}
...
<div id="archiving" class="col-md-12 mag-innert-left"><h3>{translate key="about.archiving"}</h3>
<p class="text">{$currentJournal->getLocalizedSetting('lockssLicense')|nl2br}</p>
...
{foreach key=key from=$currentJournal->getLocalizedSetting('customAboutItems') item=customAboutItem name=customAboutItems}
	{if !empty($customAboutItem.title)}
		<div id="custom-{$key|escape}" class="col-md-12 mag-innert-left"><h3>{$customAboutItem.title|escape}</h3>
		<p class="text">{$customAboutItem.content|nl2br}</p>
