...
<div id="sectionPolicies" class="col-md-12 mag-innert-left">
	<h3>{translate key="about.sectionPolicies"}</h3>
...
{if $currentJournal->getLocalizedSetting('reviewPolicy') != ''}
	<div id="peerReviewProcess" class="col-md-12 mag-innert-left"><h3>{translate key="about.peerReviewProcess"}</h3>
