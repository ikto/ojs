...
{if count($layoutEditors) > 0}
	<div id="layoutEditors" class="col-md-12 mag-innert-left">
...
{if count($copyEditors) > 0}
	<div id="copyEditors" class="col-md-12 mag-innert-left">
...
{if count($proofreaders) > 0}
	<div id="proofreaders" class="col-md-12 mag-innert-left">
