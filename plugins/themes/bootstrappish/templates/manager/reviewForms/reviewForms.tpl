...
<p class="help-block">{translate key="manager.reviewForms.list.description"}</p>

<div id="reviewForms" class="table-responsive">
	<table width="100%" class="table table-striped" id="dragTable">
		<tr>
			<td class="headseparator" colspan="4">&nbsp;</td>
		</tr>
		<tr class="heading" valign="bottom">
			<td width="40%"><label>{translate key="manager.reviewForms.title"}</label></td>
			<td width="20%"><label>{translate key="manager.reviewForms.inReview"}</label></td>
			<td width="15%"><label>{translate key="manager.reviewForms.completed"}</label></td>
			<td width="25%" align="right"><label>{translate key="common.action"}</label></td>
		</tr>
		<tr>
			<td class="headseparator" colspan="4">&nbsp;</td>
		</tr>
		...
		{if $reviewForms->wasEmpty()}
			<tr>
				<td colspan="4" class="nodata"><p class="help-block">{translate key="manager.reviewForms.noneCreated"}</p></td>
			</tr>
			<tr>
				<td colspan="4" class="endseparator">&nbsp;</td>
			</tr>
