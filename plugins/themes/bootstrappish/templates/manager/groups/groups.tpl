...
<form action="{url op="setBoardEnabled"}" method="post">
	...
	<input type="radio" id="boardEnabledOff" {if !$boardEnabled}checked="checked" {/if}name="boardEnabled" value="0"/>&nbsp;<label class="control-label" for="boardEnabledOff">{translate key="manager.groups.disableBoard"}</label><br/>
	<input type="radio" id="boardEnabledOn" {if $boardEnabled}checked="checked" {/if}name="boardEnabled" value="1"/>&nbsp;<label class="control-label" for="boardEnabledOn">{translate key="manager.groups.enableBoard"}</label><br/>
