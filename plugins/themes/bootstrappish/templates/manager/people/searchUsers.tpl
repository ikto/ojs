...
{if not $omitSearch}
	...
	<input type="hidden" name="roleId" value="{$roleId|escape}"/>
		...
		<input type="text" size="15" name="search" class="textField" value="{$search|escape}" />&nbsp;<input type="submit" value="{translate key="common.search"}" class="btn btn-info" />
	</form>
