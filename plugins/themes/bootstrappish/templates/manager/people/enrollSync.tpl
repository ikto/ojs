...
<p><p class="help-block">{translate key="manager.people.syncUserDescription"}</p></p>
...
<p><input type="submit" value="{translate key="manager.people.enrollSync"}" class="btn btn-success" /> <input type="button" value="{translate key="common.cancel"}" class="btn btn-success" onclick="history.go(-1)" /></p>
