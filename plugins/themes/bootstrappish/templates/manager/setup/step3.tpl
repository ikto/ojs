...
<table width="100%" class="table table-striped">
	<tr valign="top">
		...
		<td width="95%" class="value"><label class="control-label" for="copyrightNoticeAgree">{translate key="manager.setup.authorCopyrightNoticeAgree"}</label>
		</td>
	</tr>
	<tr valign="top">
		<td>
...
{else}
	...
	<table width="100%" class="table table-striped">
		<tr valign="top">
			...
			<td width="95%" class="value"><label class="control-label" for="metaCitations">{translate key="manager.setup.citations"}</label>
			</td>
		</tr>
	</table>
	</div>
