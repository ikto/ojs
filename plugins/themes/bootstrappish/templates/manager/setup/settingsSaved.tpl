...
<p class="help-block">{translate key="manager.setup.journalSetupUpdated"}</p>

{if $setupStep == 1}
	<div><span class="help-block">&lt;&lt; {translate key="navigation.previousStep"}</span> | <a href="{url op="setup" path="2"}">{translate key="navigation.nextStep"} &gt;&gt;</a></div>
