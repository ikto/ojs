...
<table width="100%" class="table table-striped">
	<tr valign="top">
		...
		<td width="95%" class="value">
			...
			<p><p class="help-block">{translate key="manager.setup.openAccessPolicyDescription"}</p></p>
	...
	<tr valign="top">
		...
		<td width="95%" class="value">
			...
			<p><p class="help-block">{translate key="manager.setup.subscriptionDescription"}</p></p>
			<div class="table-responsive">
			<table width="100%" class="table table-striped">
				<tr>
...
{/foreach}
	...
	<tr valign="top">
		...
		<td width="80%" colspan="2" class="value"><input type="file" name="template-file" id="template-file" class="uploadField" /><input type="submit" name="addTemplate" value="{translate key="common.upload"}" class="btn btn-success" /></td>
	</tr>
</table>
</div>
</div><!-- layoutTemplates -->
