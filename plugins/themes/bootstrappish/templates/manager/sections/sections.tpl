...
<div id="sections" class="table-responsive">
	<table width="100%" class="table table-striped" id="dragTable">
		<tr>
			<td class="headseparator" colspan="3">&nbsp;</td>
		</tr>
		<tr class="heading" valign="bottom">
			<td width="60%"><label>{translate key="section.title"}</label></td>
			<td width="25%"><label>{translate key="section.abbreviation"}</label></td>
		...
		{if $sections->wasEmpty()}
			<tr>
				<td colspan="3" class="nodata"><p class="help-block">{translate key="manager.sections.noneCreated"}</p></td>
			</tr>
			<tr>
				<td colspan="3" class="endseparator">&nbsp;</td>
			</tr>
