...
{if $newVersionAvailable}
	<div class="warningMessage" class="col-md-12 mag-innert-left">{translate key="site.upgradeAvailable.manager" currentVersion=$currentVersion latestVersion=$latestVersion siteAdminName=$siteAdmin->getFullName() siteAdminEmail=$siteAdmin->getEmail()}</div>
{/if}

<div id="managementPages" class="col-md-12 mag-innert-left">
...
<div id="managerUsers" class="col-md-12 mag-innert-left">
...
<div id="managerRoles" class="col-md-12 mag-innert-left">
