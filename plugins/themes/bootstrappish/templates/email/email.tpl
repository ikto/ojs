...
<tr valign="top">
	...
	<td class="value">
		...
		<input type="file" name="newAttachment" class="pkp_form_uploadField" /> <input name="addAttachment" type="submit" class="btn btn-success" value="{translate key="common.upload"}" />
	</td>
</tr>
{/if}
<tr valign="top">
