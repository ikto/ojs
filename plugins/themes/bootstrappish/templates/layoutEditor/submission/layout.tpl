	...
	<div class="table-responsive">
		<table width="100%" class="table table-striped">
			...
			<tr>
				...
				<td width="36%" colspan="2" class="heading"><label>{translate key="common.file"}</label></td>
				<td width="18%" class="heading"><label>{translate key="common.order"}</label></td>
				<td width="18%" class="heading"><label>{translate key="common.action"}</label></td>
			</tr>
			...
			{foreachelse}
			<tr>
				<td colspan="6" class="nodata"><p class="help-block">{translate key="common.none"}</p></td>
			</tr>
			{/foreach}
			<tr>
				<td colspan="6" class="separator">&nbsp;</td>
