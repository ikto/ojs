...
<div class="col-md-12 mag-innert-left">
	...
	<div id="assignReviewForm" class="table-responsive">
		<table width="100%" class="table table-striped">
			<tr>
				<td class="headseparator" colspan="2">&nbsp;</td>
			</tr>
			<tr class="heading" valign="bottom">
				<td width="85%"><label>{translate key="manager.reviewForms.title"}</label></td>
			...
			{if $reviewForms->wasEmpty()}
				<tr>
					<td colspan="2" class="nodata"><p class="help-block">{translate key="manager.reviewForms.noneCreated"}</p></td>
				</tr>
				<tr>
