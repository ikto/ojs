...
<div id="subscriptionTypes" class="table-responsive">
	<table width="100%" class="table table-striped" id="subscriptionTypesTable">
		<tr>
			<td colspan="5" class="headseparator">&nbsp;</td>
		</tr>
		<tr class="heading" valign="bottom">
			<td width="40%"><label>{translate key="manager.subscriptionTypes.name"}</label></td>
			<td width="10%"><label>{translate key="manager.subscriptionTypes.subscriptions"}</label></td>
			<td width="20%"><label>{translate key="manager.subscriptionTypes.duration"}</label></td>
			<td width="15%"><label>{translate key="manager.subscriptionTypes.cost"}</label></td>
		...
		{if $subscriptionTypes->wasEmpty()}
			<tr>
				<td colspan="5" class="nodata"><p class="help-block">{translate key="manager.subscriptionTypes.noneCreated"}</p></td>
			</tr>
			<tr>
