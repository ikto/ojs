...
{/if}
	...
	<tr valign="top">
		...
		<td colspan="2" width="80%" class="value"><input type="file" name="pageHeaderTitleImage" class="uploadField" /> <input type="submit" name="uploadPageHeaderTitleImage" value="{translate key="common.upload"}" class="btn btn-success" /></td>
	</tr>
	<tr valign="top">
		<td colspan="2">
	...
	<tr valign="top">
		...
		<td colspan="2" width="80%" class="value">
			<input type="file" name="siteStyleSheet" class="uploadField" /> <input type="submit" name="uploadSiteStyleSheet" value="{translate key="common.upload"}" class="btn btn-success" />
