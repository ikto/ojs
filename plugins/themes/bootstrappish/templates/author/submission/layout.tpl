		...
		<table width="100%" class="table table-striped">
			{if $useLayoutEditors}
				<tr>
					...
					<td width="15%" class="heading"><label>{translate key="submission.request"}</label></td>
					<td width="15%" class="heading"><label>{translate key="submission.underway"}</label></td>
					<td width="15%" class="heading"><label>{translate key="submission.complete"}</label></td>
			...
			<tr>
				...
				<td width="40%" colspan="2" class="heading"><label>{translate key="common.file"}</label></td>
				<td colspan="2">&nbsp;</td>
			</tr>
			...
			<tr>
				...
				<td colspan="4" class="heading"><label>{translate key="common.file"}</label></td>
			</tr>
