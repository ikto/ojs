...
<table width="100%" class="table table-striped">
	<tr valign="top">
		<td width="20%"></td>
		<td width="80%"><input type="checkbox" name="sharingEnabled" id="sharingEnabled" {if isset($sharingEnabled) && $sharingEnabled} checked="checked" {/if} /> <label class="control-label" for="sharingEnabled">{translate key="rt.admin.sharing.enabled"}</label></td>
	</tr>
	<tr valign="top">
	...
	<tr>
		<td></td>
		<td><input type="checkbox" name="sharingDropDownMenu" id="sharingDropDownMenu" {if isset($sharingDropDownMenu) && $sharingDropDownMenu} checked="checked" {/if} /> <label class="control-label" for="sharingDropDownMenu">{translate key="rt.admin.sharing.dropDownMenuLabel"}</label></td>
	</tr>
</table>
</div>
