...
<div id="enableRT"><input type="checkbox" {if $enabled}checked="checked" {/if}name="enabled" value="1" id="enabled"/>&nbsp;&nbsp;<label class="control-label" for="enabled">{translate key="rt.admin.settings.enableReadingTools"}</label></div><br/>

<div class="separator"></div>
<div id="rtAdminOptions" class="table-responsive">
...
<table width="100%" class="table table-striped">
	...
	<tr valign="top">
		<td><input type="checkbox" name="viewReviewPolicy" id="viewReviewPolicy" value="1"{if $viewReviewPolicy} checked="checked"{/if} /></td>
...
<label class="control-label" for="version">{translate key="rt.admin.settings.relatedItems"}</label>&nbsp;&nbsp;<select name="version" id="version" class="selectMenu">
