...
<div id="versions" class="table-responsive">
	<table class="table table-striped" width="100%">
		<tr><td class="headseparator" colspan="3">&nbsp;</td></tr>
		<tr valign="top">
			<td class="heading" width="40%"><label>{translate key="rt.version.title"}</label></td>
			<td class="heading" width="20%"><label>{translate key="rt.version.locale"}</label></td>
...
<form role="form" method="post" action="{url op="importVersion"}" enctype="multipart/form-data">
	<div class="form-group"><input type="file" class="form-control" name="versionFile" /></div>
	<input type="submit" class="btn btn-warning" value="{translate key="rt.admin.versions.importVersion"}" />
</form>
