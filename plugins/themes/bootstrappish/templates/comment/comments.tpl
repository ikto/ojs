...
{/if}
<div id="comments" class="col-md-12 mag-innert-left">
	{if $comment}
		{assign var=user value=$comment->getUser()}
		<div id="comment" class="col-md-12 mag-innert-left">
	...
	<p class="help-block">{$child->getBody()|strip_tags|nl2br|truncate:300:"... $moreLink"}</p>

	{assign var=grandChildren value=$child->getChildren()}
	{if $grandChildren}<ul class="stay">{/if}
