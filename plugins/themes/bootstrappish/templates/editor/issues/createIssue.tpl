...
<form role="form" id="issue" method="post" action="{url op="saveIssue"}" enctype="multipart/form-data">
	...
	<div id="identification" class="table-responsive">
		...
		<table width="100%" class="table table-striped">
			...
			<tr valign="top">
				...
				<td class="value"><div class="form-group"><input type="text" name="number" id="number" value="{$number|escape}" size="5" maxlength="5" class="form-control" /></div></td>
			</tr>
			<tr valign="top">
			...
			<tr valign="top">
				...
				<td width="80%" class="value">
					<div class="form-group">
						...
						<p class="help-block">{translate key="editor.issues.coverPageInstructions"}</p>
					</div>
				</td>
			</tr>
			<tr valign="top">
