			...
			<tr>
				...
				<td colspan="4">
					...
					<form role="form" method="post" action="{url op="uploadCopyeditVersion"}"  enctype="multipart/form-data">
						...
						<div class="form-group"><input type="file" name="upload"{if not $initialCopyeditSignoff->getDateNotified() or $initialCopyeditSignoff->getDateCompleted()} disabled="disabled"{/if} class="form-control" /></div>
						<input type="submit" class="btn btn-success" value="{translate key="common.upload"}"{if not $initialCopyeditSignoff->getDateNotified() or $initialCopyeditSignoff->getDateCompleted()} disabled="disabled"{/if} />
					</form>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan="4">
					...
					<form role="form" method="post" action="{url op="uploadCopyeditVersion"}"  enctype="multipart/form-data">
						...
						<div class="form-group"><input type="file" name="upload"{if not $finalCopyeditSignoff->getDateNotified() or $finalCopyeditSignoff->getDateCompleted()} disabled="disabled"{/if} class="form-control"></div>
						<input type="submit" class="btn btn-success" value="{translate key="common.upload"}"{if not $finalCopyeditSignoff->getDateNotified() or $finalCopyeditSignoff->getDateCompleted()} disabled="disabled"{/if} />
					</form>
				</td>
			</tr>
			<tr>
