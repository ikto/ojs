...
<div class="table-responsive">
	<table class="table table-striped" width="100%">
		...
		<tr valign="top">
			<td class="heading" width="25%" colspan="2"><label>{translate key="rt.metadata.dublinCore"}</label></td>
			<td class="heading" width="25%"><label>{translate key="rt.metadata.pkpItem"}</label></td>
			<td class="heading" width="50%"><label>{translate key="rt.metadata.forThisDocument"}</label></td>
		</tr>
