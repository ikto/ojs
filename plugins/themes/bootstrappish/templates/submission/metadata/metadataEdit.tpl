...
<form role="form" id="metadata" method="post" action="{url op="saveMetadata"}" enctype="multipart/form-data">
				...
				<table width="100%" class="table table-striped">
					{foreach name=authors from=$authors key=authorIndex item=author}
						...
						<tr valign="top">
							...
							<td class="value"><div class="form-group"><input type="text" name="authors[{$authorIndex|escape}][email]" id="authors-{$authorIndex|escape}-email" value="{$author.email|escape}" size="30" maxlength="90" class="form-control" /></div></td>
						</tr>
						<tr valign="top">
						...
						<tr valign="top">
							<td>{fieldLabel name="authors-$authorIndex-biography" key="user.biography"}<label class="help-block">{translate key="user.biography.description"}</label></td>
							<td class="value"><div class="form-group"><textarea name="authors[{$authorIndex|escape}][biography][{$formLocale|escape}]" id="authors-{$authorIndex|escape}-biography" rows="5" cols="40" class="form-control">{$author.biography[$formLocale]|escape}</textarea></div></td>
						</tr>
						...
						{if $smarty.foreach.authors.total > 1}
							<tr valign="top">
								<td><label>{translate key="author.submit.reorder"}</label></td>
							...
							<tr valign="top">
								<td>&nbsp;</td>
								<td><div class="form-group"><input type="radio" name="primaryContact" id="primaryContact-{$authorIndex|escape}" value="{$authorIndex|escape}"{if $primaryContact == $authorIndex} checked="checked"{/if} /> <label class="control-label" for="primaryContact-{$authorIndex|escape}">{translate key="author.submit.selectPrincipalContact"}</label></div></td>
								<td class="labelRightPlain">&nbsp;</td>
							</tr>
							<tr valign="top">
								<td>&nbsp;</td>
								<td class="value"><input type="submit" name="delAuthor[{$authorIndex|escape}]" value="{translate key="author.submit.deleteAuthor"}" class="btn btn-warning" /></td>
							</tr>
						{/if}
					...
					{foreachelse}
						...
						<tr valign="top">
							...
							<td class="value"><div class="form-group"><input type="text" name="authors[0][email]" id="authors-0-email" size="30" maxlength="90" class="form-control" /></div></td>
						</tr>
						<tr valign="top">
							<td>{fieldLabel name="authors-0-url" key="user.url"}</td>
							<td class="value"><div class="form-group"><input type="text" name="authors[0][url]" id="authors-0-url" size="30" maxlength="90" class="form-control" /></div></td>
						</tr>
						{if $currentJournal->getSetting('requireAuthorCompetingInterests')}
							<tr valign="top">
						...
						<tr valign="top">
							...
							<td class="value"><div class="form-group"><textarea name="authors[0][biography][{$formLocale|escape}]" id="authors-0-biography" rows="5" cols="40" class="form-control"></textarea></div></td>
						</tr>
					{/foreach}
				</table>
			</div>
		...
		<div class="table-responsive">
			<table width="100%" class="table table-striped">
				...
				<tr valign="top">
					...
					<td class="value"><div class="form-group"><textarea name="abstract[{$formLocale|escape}]" id="abstract" rows="15" cols="60" class="form-control">{$abstract[$formLocale]|escape}</textarea></div></td>
				</tr>
			</table>
		</div>
	</div>
	...
	<div id="cover" class="col-md-12 mag-innert-left">
		...
		<div class="table-responsive">
			<table width="100%" class="table table-striped">
				<tr valign="top">
					<td colspan="2"><div class="form-group"><input type="checkbox" name="showCoverPage[{$formLocale|escape}]" id="showCoverPage" value="1" {if $showCoverPage[$formLocale]} checked="checked"{/if} /> <label class="control-label" for="showCoverPage">{translate key="editor.article.showCoverPage"}</label></div></td>
				</tr>
				<tr valign="top">
					<td width="20%">{fieldLabel name="coverPage" key="editor.article.coverPage"}</td>
					<td width="80%" class="value"><div class="form-group"><input type="file" name="coverPage" id="coverPage" class="form-control" /><p class="help-block">{translate key="form.saveToUpload"}<br />{translate key="editor.article.coverPageInstructions"}<br />{translate key="editor.article.uploaded"}:</p>&nbsp;{if $fileName[$formLocale]}<a href="javascript:openWindow('{$publicFilesDir}/{$fileName[$formLocale]|escape:"url"}');" class="file">{$originalFileName[$formLocale]}</a>&nbsp;<a href="{url op="removeArticleCoverPage" path=$articleId|to_array:$formLocale}" onclick="return confirm('{translate|escape:"jsparam" key="editor.article.removeCoverPage"}')">{translate key="editor.article.remove"}</a>{else}&mdash;{/if}</div></td>
				</tr>
				<tr valign="top">
				...
				<tr valign="top">
					...
					<td width="80%" class="value"><div class="form-group"><input type="checkbox" name="hideCoverPageToc[{$formLocale|escape}]" id="hideCoverPageToc" value="1" {if $hideCoverPageToc[$formLocale]} checked="checked"{/if} /> <label class="control-label" for="hideCoverPageToc">{translate key="editor.article.hideCoverPageToc"}</label></div></td>
				</tr>
				<tr valign="top">
					<td width="20%">&nbsp;</td>
					<td class="value"><div class="form-group"><input type="checkbox" name="hideCoverPageAbstract[{$formLocale|escape}]" id="hideCoverPageAbstract" value="1" {if $hideCoverPageAbstract[$formLocale]} checked="checked"{/if} /> <label class="control-label" for="hideCoverPageAbstract">{translate key="editor.article.hideCoverPageAbstract"}</label></div></td>
				</tr>
			</table>
		</div>
	</div>
	...
	<div id="indexing" class="col-md-12 mag-innert-left">
		...
		{if $journalSettings.metaDiscipline || $journalSettings.metaSubjectClass || $journalSettings.metaSubject || $journalSettings.metaCoverage || $journalSettings.metaType}<p class="help-block">{translate key="author.submit.submissionIndexingDescription"}</p>{/if}
		<div class="table-responsive">
			<table width="100%" class="table table-striped">
				{if $journalSettings.metaDiscipline}
					<tr valign="top">
						...
						<td class="value">
							<div class="form-group"><input type="text" name="discipline[{$formLocale|escape}]" id="discipline" value="{$discipline[$formLocale]|escape}" size="40" maxlength="255" class="form-control" /></div>
							{if $currentJournal->getLocalizedSetting('metaDisciplineExamples') != ''}
								<p class="help-block">{$currentJournal->getLocalizedSetting('metaDisciplineExamples')|escape}</p>
							{/if}
						</td>
					</tr>
					<tr>
					...
					<tr valign="top">
						...
						<td class="value">
							<div class="form-group">
								...
								<p class="help-block">{translate key="author.submit.subjectClassInstructions"}</p>
							</div>
						</td>
					</tr>
					<tr>
				...
				{if $journalSettings.metaSubject}
					<tr valign="top">
						...
						<td class="value">
							<div class="form-group"><input type="text" name="subject[{$formLocale|escape}]" id="subject" value="{$subject[$formLocale]|escape}" size="40" maxlength="255" class="form-control" /></div>
							{if $currentJournal->getLocalizedSetting('metaSubjectExamples') != ''}
								<p class="help-block">{$currentJournal->getLocalizedSetting('metaSubjectExamples')|escape}</p>
							{/if}
						</td>
					</tr>
					<tr>
				...
				{if $journalSettings.metaCoverage}
					<tr valign="top">
						...
						<td class="value">
							<div class="form-group"><input type="text" name="coverageGeo[{$formLocale|escape}]" id="coverageGeo" value="{$coverageGeo[$formLocale]|escape}" size="40" maxlength="255" class="form-control" /></div>
							{if $currentJournal->getLocalizedSetting('metaCoverageGeoExamples') != ''}
								<p class="help-block">{$currentJournal->getLocalizedSetting('metaCoverageGeoExamples')|escape}</p>
							{/if}
						</td>
					</tr>
					<tr>
					...
					<tr valign="top">
						...
						<td class="value">
							<div class="form-group"><input type="text" name="coverageChron[{$formLocale|escape}]" id="coverageChron" value="{$coverageChron[$formLocale]|escape}" size="40" maxlength="255" class="form-control" /></div>
							{if $currentJournal->getLocalizedSetting('metaCoverageChronExamples') != ''}
								<p class="help-block">{$currentJournal->getLocalizedSetting('metaCoverageChronExamples')|escape}</p>
							{/if}
						</td>
					</tr>
					<tr>
					...
					<tr valign="top">
						...
						<td class="value">
							<div class="form-group"><input type="text" name="coverageSample[{$formLocale|escape}]" id="coverageSample" value="{$coverageSample[$formLocale]|escape}" size="40" maxlength="255" class="form-control" /></div>
							{if $currentJournal->getLocalizedSetting('metaCoverageResearchSampleExamples') != ''}
								<p class="help-block">{$currentJournal->getLocalizedSetting('metaCoverageResearchSampleExamples')|escape}</p>
							{/if}
						</td>
					</tr>
					<tr>
				...
				{if $journalSettings.metaType}
					<tr valign="top">
						...
						<td class="value">
							<div class="form-group"><input type="text" name="type[{$formLocale|escape}]" id="type" value="{$type[$formLocale]|escape}" size="40" maxlength="255" class="form-control" /></div>
						</td>
					</tr>
					<tr>
						<td colspan="2" class="separator">&nbsp;</td>
		...
		<div class="table-responsive">
			<table width="100%" class="table table-striped">
				<tr valign="top">
					...
					<td width="80%" class="value">
						<div class="form-group"><input type="text" name="sponsor[{$formLocale|escape}]" id="sponsor" value="{$sponsor[$formLocale]|escape}" size="60" maxlength="255" class="form-control" /></div>
					</td>
				</tr>
			</table>
		</div>
	...
	{if $isEditor}
		<div id="display" class="col-md-12 mag-innert-left">
				...
				<table width="100%" class="table table-striped">
					<tr valign="top">
						...
						<td width="80%" class="value">{translate key="editor.article.hideTocAuthorDescription"}:
							<div class="form-group">
								<select name="hideAuthor" id="hideAuthor" class="form-control">
	...
	<p><input type="submit" value="{translate key="submission.saveMetadata"}" class="btn btn-success"/> <input type="button" value="{translate key="common.cancel"}" class="btn btn-danger" onclick="history.go(-1)" /></p>
